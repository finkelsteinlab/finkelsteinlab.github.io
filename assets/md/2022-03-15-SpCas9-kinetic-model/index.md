...
***Figure 4.*** Physical parameters estimated from NucleaSeq and CHAMP datasets. **a** The on-target free-energy landscape **b** Energetic penalties **c)** The estimates for the on-rate at 1 nM Cas9-sgRNA concentration ([1]).
