...
Finally, we tested whether the ideal conditions we identified for detection of synthetic targets—RNP pooling, C10 *trans*-substrate, and low salt buffer—would also enhance detection of genomic DNA from *M. ulcerans*. We had previously used these conditions to detect pathogen DNA in clinical swab samples from patients with Buruli ulcer, a necrotizing skin disease caused by *M. ulcerans* [6]. We compared the *trans*-activity of the 20-RNP pool and that of the best individual RNP (RNP-F1) using both FQ-C10 in low salt Buffer-a and FQ-T5 in high-salt Buffer-b ([Fig. 5H](#fig5) and Supplementary Fig. S14F). Using RNP pooling, FQ-C10 and Buffer-a, *trans*-cleavage turnovers per genome were 60-fold higher than when using the best individual RNP, FQ-T5, and Buffer-b (Supplementary Table S15B). These results demonstrate that the improvements we identified for detecting synthetic targets may be generally applicable to targets encountered in a diagnostic context.
